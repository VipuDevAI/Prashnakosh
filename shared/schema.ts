...
import { pgTable, text, varchar, integer, boolean, timestamp, jsonb, decimal, bigint } from "drizzle-orm/pg-core";
...
export const tests = pgTable("tests", {
  ...
  setsApproved: boolean("sets_approved").default(false),
  setsApprovedBy: varchar("sets_approved_by"),
  setsApprovedAt: timestamp("sets_approved_at"),
